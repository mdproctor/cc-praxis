...
CHAINING_TRUTH = {
    ...
    'design-snapshot': {'chains_to': ['adr', 'custom-git-commit', 'git-commit', 'idea-log', 'java-git-commit', 'write-blog'], 'invoked_by': ['write-blog'], 'builds_on': [], 'extended_by': []},
    'garden': {'chains_to': [], 'invoked_by': [], 'builds_on': [], 'extended_by': []},
    'git-commit': {'chains_to': ['blog-git-commit', 'issue-workflow', 'python-code-review', 'ts-code-review', 'update-claude-md'], 'invoked_by': ['adr', 'design-snapshot', 'idea-log', 'python-code-review', 'ts-code-review', 'write-blog'], 'builds_on': [], 'extended_by': ['custom-git-commit', 'java-git-commit']},
    ...
    'write-blog': {'chains_to': ['adr', 'custom-git-commit', 'design-snapshot', 'git-commit', 'java-git-commit'], 'invoked_by': ['adr', 'design-snapshot'], 'builds_on': [], 'extended_by': []},
}
